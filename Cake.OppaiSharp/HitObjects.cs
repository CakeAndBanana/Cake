...
namespace OppaiSharp
{
    public class HitObject
    {
        ...
        public Dictionary<StrainType, double> Strains { get; } = new Dictionary<StrainType, double>(2)
            {{StrainType.Speed, 0.0}, {StrainType.Aim, 0.0}};
        ...
        {
            return $"{{ time={Time}, type={TypeString()}, data={Data}, normpos={Normpos}, angle={Angle}, "
